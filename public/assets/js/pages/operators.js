...
const loadDatatableOperators = () => {
  if ($("#datatable-operators").length) {
    tableOperators = $("#datatable-operators").DataTable({
      ...
      dom: "<'row'<'col-3'l><'col-6 text-center'B><'col-3'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
      //   order: [[2, 'asc'],[3,'asc']],
      buttons: [
        "colvis",
        {
