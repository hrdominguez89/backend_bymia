...
class Orders
{
    ...
    public function generateOrderToCRM()
    {
        ...
        return [
            ...
            "payments_files" => $payments_files_result?$payments_files_result[0]:[],//este y payments_received_files por ahora los dejo asi
            "payments_received_files" => $payments_files_result,
